...
libmain(int argc, char **argv)
{
  ...
  800048:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80004b:	89 75 fc             	mov    %esi,-0x4(%ebp)
  80004e:	8b 5d 08             	mov    0x8(%ebp),%ebx
  800051:	8b 75 0c             	mov    0xc(%ebp),%esi
	// set thisenv to point at our Env structure in envs[].
	// LAB 3: Your code here.
	thisenv = &envs[ENVX(sys_getenvid())];
  800054:	e8 0b 01 00 00       	call   800164 <sys_getenvid>
  ...
  800074:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  800079:	89 74 24 04          	mov    %esi,0x4(%esp)
  ...
  80008a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80008d:	8b 75 fc             	mov    -0x4(%ebp),%esi
  800090:	89 ec                	mov    %ebp,%esp
  800092:	5d                   	pop    %ebp
  800093:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  80013a:	00 
  80013b:	c7 44 24 08 2a 0f 80 	movl   $0x800f2a,0x8(%esp)
  800142:	00 
  800143:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014a:	00 
  80014b:	c7 04 24 47 0f 80 00 	movl   $0x800f47,(%esp)
  800152:	e8 3d 00 00 00       	call   800194 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80019f:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8001a5:	e8 ba ff ff ff       	call   800164 <sys_getenvid>
  ...
  8001c0:	c7 04 24 58 0f 80 00 	movl   $0x800f58,(%esp)
  ...
  8001d6:	e8 51 00 00 00       	call   80022c <vcprintf>
	cprintf("\n");
  8001db:	c7 04 24 7c 0f 80 00 	movl   $0x800f7c,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001f9:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  8001fd:	83 c0 01             	add    $0x1,%eax
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800268:	e8 a8 01 00 00       	call   800415 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800280:	e8 23 fe ff ff       	call   8000a8 <sys_cputs>
