...
umain(int argc, char **argv)
{
  ...
  800058:	c7 04 24 40 0f 80 00 	movl   $0x800f40,(%esp)
  80005f:	e8 0b 01 00 00       	call   80016f <cprintf>
}
  800064:	c9                   	leave  
  800065:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800078:	e8 5b 0b 00 00       	call   800bd8 <sys_getenvid>
  ...
  800094:	7e 07                	jle    80009d <libmain+0x37>
		binaryname = argv[0];
  ...
  800098:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  80009d:	89 74 24 04          	mov    %esi,0x4(%esp)
  8000a1:	89 1c 24             	mov    %ebx,(%esp)
  ...
  8000ae:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8000b1:	8b 75 fc             	mov    -0x4(%ebp),%esi
  8000b4:	89 ec                	mov    %ebp,%esp
  8000b6:	5d                   	pop    %ebp
  8000b7:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000f9:	e8 1e 0a 00 00       	call   800b1c <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80014a:	e8 a6 01 00 00       	call   8002f5 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800162:	e8 b5 09 00 00       	call   800b1c <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025f:	0f be 80 58 0f 80 00 	movsbl 0x800f58(%eax),%eax
...
008002f5 <vprintfmt>:
{
  ...
  800449:	c7 44 24 08 70 0f 80 	movl   $0x800f70,0x8(%esp)
  800450:	00 
  ...
  800469:	c7 44 24 08 79 0f 80 	movl   $0x800f79,0x8(%esp)
  800470:	00 
  ...
  80049b:	b8 69 0f 80 00       	mov    $0x800f69,%eax
