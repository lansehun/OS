...
umain(int argc, char **argv)
{
  ...
  800049:	e8 68 00 00 00       	call   8000b6 <sys_cputs>
}
  80004e:	c9                   	leave  
  80004f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800062:	e8 0b 01 00 00       	call   800172 <sys_getenvid>
...
exit(void)
{
  ...
  8000af:	e8 61 00 00 00       	call   800115 <sys_env_destroy>
}
  8000b4:	c9                   	leave  
  8000b5:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000bc:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8000bf:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8000c2:	89 7d fc             	mov    %edi,-0x4(%ebp)
	asm volatile("int %1\n"
  ...
  8000d8:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8000db:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8000de:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_cgetc(void)
{
  ...
  8000eb:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8000ee:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8000f1:	89 7d fc             	mov    %edi,-0x4(%ebp)
	asm volatile("int %1\n"
  ...
  800108:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80010b:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80010e:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_env_destroy(envid_t envid)
{
  ...
  800118:	83 ec 38             	sub    $0x38,%esp
  80011b:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80011e:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800121:	89 7d fc             	mov    %edi,-0x4(%ebp)
	asm volatile("int %1\n"
  ...
  80013b:	7e 28                	jle    800165 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80013d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800141:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800148:	00 
  800149:	c7 44 24 08 58 0f 80 	movl   $0x800f58,0x8(%esp)
  800150:	00 
  800151:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800158:	00 
  800159:	c7 04 24 75 0f 80 00 	movl   $0x800f75,(%esp)
  800160:	e8 3d 00 00 00       	call   8001a2 <_panic>
	return syscall(SYS_env_destroy, 1, envid, 0, 0, 0, 0);
}
  800165:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800168:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80016b:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_getenvid(void)
{
  ...
  800178:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80017b:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80017e:	89 7d fc             	mov    %edi,-0x4(%ebp)
	asm volatile("int %1\n"
  ...
  800195:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800198:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80019b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80019e:	89 ec                	mov    %ebp,%esp
  8001a0:	5d                   	pop    %ebp
  8001a1:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001ad:	8b 35 04 20 80 00    	mov    0x802004,%esi
  8001b3:	e8 ba ff ff ff       	call   800172 <sys_getenvid>
  8001b8:	8b 55 0c             	mov    0xc(%ebp),%edx
  8001bb:	89 54 24 10          	mov    %edx,0x10(%esp)
  8001bf:	8b 55 08             	mov    0x8(%ebp),%edx
  8001c2:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8001c6:	89 74 24 08          	mov    %esi,0x8(%esp)
  8001ca:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001ce:	c7 04 24 84 0f 80 00 	movl   $0x800f84,(%esp)
  8001d5:	e8 c1 00 00 00       	call   80029b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8001da:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8001de:	8b 45 10             	mov    0x10(%ebp),%eax
  8001e1:	89 04 24             	mov    %eax,(%esp)
  8001e4:	e8 51 00 00 00       	call   80023a <vcprintf>
	cprintf("\n");
  8001e9:	c7 04 24 4c 0f 80 00 	movl   $0x800f4c,(%esp)
  8001f0:	e8 a6 00 00 00       	call   80029b <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8001f5:	cc                   	int3   
  8001f6:	eb fd                	jmp    8001f5 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  800225:	e8 8c fe ff ff       	call   8000b6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800276:	e8 aa 01 00 00       	call   800425 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80028e:	e8 23 fe ff ff       	call   8000b6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80038f:	0f be 80 a8 0f 80 00 	movsbl 0x800fa8(%eax),%eax
...
00800425 <vprintfmt>:
{
  ...
  800579:	c7 44 24 08 c0 0f 80 	movl   $0x800fc0,0x8(%esp)
  800580:	00 
  ...
  800599:	c7 44 24 08 c9 0f 80 	movl   $0x800fc9,0x8(%esp)
  8005a0:	00 
  ...
  8005cb:	b8 b9 0f 80 00       	mov    $0x800fb9,%eax
