...
libmain(int argc, char **argv)
{
  ...
  80004c:	e8 0b 01 00 00       	call   80015c <sys_getenvid>
  ...
  800082:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800085:	8b 75 fc             	mov    -0x4(%ebp),%esi
  800088:	89 ec                	mov    %ebp,%esp
  80008a:	5d                   	pop    %ebp
  80008b:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800132:	00 
  800133:	c7 44 24 08 2a 0f 80 	movl   $0x800f2a,0x8(%esp)
  80013a:	00 
  80013b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800142:	00 
  800143:	c7 04 24 47 0f 80 00 	movl   $0x800f47,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001b8:	c7 04 24 58 0f 80 00 	movl   $0x800f58,(%esp)
  8001bf:	e8 c1 00 00 00       	call   800285 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8001c4:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8001c8:	8b 45 10             	mov    0x10(%ebp),%eax
  8001cb:	89 04 24             	mov    %eax,(%esp)
  8001ce:	e8 51 00 00 00       	call   800224 <vcprintf>
	cprintf("\n");
  8001d3:	c7 04 24 7c 0f 80 00 	movl   $0x800f7c,(%esp)
  8001da:	e8 a6 00 00 00       	call   800285 <cprintf>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001e5:	53                   	push   %ebx
  8001e6:	83 ec 14             	sub    $0x14,%esp
  8001e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8001ec:	8b 03                	mov    (%ebx),%eax
  8001ee:	8b 55 08             	mov    0x8(%ebp),%edx
  8001f1:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  8001f5:	83 c0 01             	add    $0x1,%eax
  8001f8:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  8001fa:	3d ff 00 00 00       	cmp    $0xff,%eax
  8001ff:	75 19                	jne    80021a <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800201:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800208:	00 
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800259:	c7 04 24 e2 01 80 00 	movl   $0x8001e2,(%esp)
  800260:	e8 a0 01 00 00       	call   800405 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800278:	e8 23 fe ff ff       	call   8000a0 <sys_cputs>
