	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	0f be 80 71 0f 80 00 	movsbl 0x800f71(%eax),%eax
...
008002e5 <vprintfmt>:
{
  ...
  800439:	c7 44 24 08 89 0f 80 	movl   $0x800f89,0x8(%esp)
  800440:	00 
  ...
  800459:	c7 44 24 08 92 0f 80 	movl   $0x800f92,0x8(%esp)
  800460:	00 
  ...
  80048b:	b8 82 0f 80 00       	mov    $0x800f82,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c3a:	e8 b9 f4 ff ff       	call   8000f8 <vcprintf>
	cprintf("\n");
  800c3f:	c7 04 24 d0 11 80 00 	movl   $0x8011d0,(%esp)
